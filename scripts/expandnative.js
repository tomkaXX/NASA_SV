...
/*HTMLElement.prototype.insertAfter = function(newNode, refNode) {
    return refNode.nextElementSibling ? this.insertBefore(newNode, refNode.nextElementSibling) : this.appendChild(newNode);
};*/
...
if(!String.prototype.format){
    String.prototype.format = function(kwargs) {
        return this.replace(/\{([^{}]*)\}/g, function($0, $1) {
            return typeof kwargs[$1] != 'undefined' ? kwargs[$1] : $0;
        });
    };
}
